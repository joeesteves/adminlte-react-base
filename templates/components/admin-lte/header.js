      ...
      <div className="navbar-custom-menu">
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown messages-menu">
            ...
            <small><i className="fa fa-clock-o"></i> 5 mins</small>
                  ...
                  <li>
                    <a href="#">
                      <div className="pull-left">
                        <img src={require("admin-lte/dist/img/user3-128x128.jpg")} className="img-circle" alt="User Image" />
                      </div>
                      <h4>
            ...
            <small><i className="fa fa-clock-o"></i> 2 hours</small>
                  ...
                  <li>
                    <a href="#">
                      <div className="pull-left">
                        <img src={require("admin-lte/dist/img/user4-128x128.jpg")} className="img-circle" alt="User Image" />
                      </div>
                      <h4>
                        Developers
          ...
          <li className="dropdown user user-menu">
            <a href="#" className="dropdown-toggle" data-toggle="dropdown">
              <img src={require("admin-lte/dist/img/user2-160x160.jpg")} className="user-image" alt="User Image" />
