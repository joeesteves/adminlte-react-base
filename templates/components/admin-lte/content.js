        ...
        <section className="col-lg-7 connectedSortable">
          ...
          <div className="box box-success">
            ...
            <div className="box-body chat" id="chat-box">
              ...
              <div className="item">
                <img src={require("admin-lte/dist/img/user4-128x128.jpg")} alt="user image" className="online" />
              ...
              <div className="item">
                <img src={require("admin-lte/dist/img/user3-128x128.jpg")} alt="user image" className="offline" />
              ...
              <div className="item">
                <img src={require("admin-lte/dist/img/user2-160x160.jpg")} alt="user image" className="offline" />
