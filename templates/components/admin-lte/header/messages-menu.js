      ...
      <li>
        ...
        <ul className="menu">
          ...
          <li>
            <a href="">
              <div className="pull-left">
                <img src={require("admin-lte/dist/img/user3-128x128.jpg")} className="img-circle" alt="User" />
              </div>
              <h4>
          ...
          <li>
            <a href="">
              <div className="pull-left">
                <img src={require("admin-lte/dist/img/user4-128x128.jpg")} className="img-circle" alt="User" />
              </div>
              <h4>
                Developers
